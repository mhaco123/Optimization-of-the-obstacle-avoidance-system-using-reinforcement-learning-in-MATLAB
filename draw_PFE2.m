...
for i=1:5:length(vect_t)
    ...
    % Robot plotting (x,y) the robot radius is 0.09 m
         % filled circle
    %rectangle('Position',[vect_x_cur(i)-0.1 vect_y_cur(i)-0.1 0.2 0.2]','Curvature',[1 1],'FaceColor','');
         % empty circle
    rectangle('Position',[vect_x_cur(i)-0.1 vect_y_cur(i)-0.1 0.2 0.2]','Curvature',[1 1],'EdgeColor','c','LineWidth',0.5)     
